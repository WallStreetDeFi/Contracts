...
//
// Copyright of Wall Street Decentral
//
//
// 
// WALL has 7% tax split across 7 protocols
// 
// 1. Burn
// 2. Buyback
// 3. Reserves
...
/**
 * @dev The official WALL smart contract
 */
contract WALL is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "WALL STREET DECENTRAL (WALLCOIN.IO)";
    string private _symbol   = "WALL";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for WALL/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xb3c7b8987db782da25d943b2Edd8245fA2234166); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion WALL will be used to buy at maximum in any one trade
    ...
    uint256 private _lotteryPool         = 0;                  // lottery pool
    ...
    /**
     * @notice Withdraws non-WALL tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts WALL balance for buybacks, Farming, liquidity and marketing
    ...
    /**
     * @notice Burns WALL tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of WALL tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from WALL)
